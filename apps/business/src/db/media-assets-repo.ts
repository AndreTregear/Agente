...
export async function getAssetById(id: string, tenantId?: string): Promise<MediaAsset | null> {
  const sql = tenantId
...
export async function deleteAsset(id: string, tenantId?: string): Promise<MediaAsset | null> {
  const sql = tenantId
