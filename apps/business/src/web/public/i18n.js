...
(function() {
  ...
  const T = {
    en: {
      ...
      'nav.about': 'About',
      'nav.contact': 'Contact',
      'nav.cta': 'Chat with Agente',

      // Hero
      'hero.badge': 'Now Automating 1,000+ Businesses',
      'hero.title.1': 'Your WhatsApp.',
      'hero.title.2': 'Now an AI Sales Machine.',
      'hero.subtitle': 'Agente transforms your WhatsApp into a tireless AI assistant that handles customer conversations, takes orders, processes payments, and manages your entire business — 24 hours a day, 7 days a week.',
      ...
      'features.subtitle': 'From the first customer message to the final delivery — Agente handles it all through the app your customers already use every day.',
      ...
      'step.1.desc': 'Scan a QR code from your dashboard and Agente connects to your WhatsApp Business number. That\'s it — your AI is now listening.',
      ...
      'step.3.desc': 'Agente handles conversations, creates orders, processes payments, and keeps your customers happy — while you track everything from your dashboard.',

      // Testimonials
      'test.tag': 'Testimonials',
      'test.title.1': 'Loved by business owners',
      'test.title.2': 'who never look back.',
      'test.1.text': '"Before Agente I was answering WhatsApp messages until 2am. Now my AI handles everything and I wake up to orders already confirmed and paid. My sales tripled in the first month."',
      'test.2.text': '"The Yape payment integration is magic. Customers pay, Agente confirms automatically, and the order starts preparing. I don\'t even have to check my phone anymore."',
      'test.3.text': '"I sell clothes online and Agente handles all the sizing questions, stock checks, and order creation. It\'s like having a full-time employee that never sleeps and never makes mistakes."',
      ...
      'price.starter.desc': 'Perfect to try Agente and see the magic',
      'price.growth': 'Growth',
      ...
      // About
      'about.tag': 'About Agente',
      'about.title.1': 'Built by entrepreneurs,',
      'about.title.2': 'for entrepreneurs.',
      'about.p1': 'We started Agente because we saw small business owners in Latin America drowning in WhatsApp messages — responding late, losing orders, and burning out. They didn\'t need another complicated SaaS tool. They needed something that just works, right inside the app they already use.',
      'about.p2': 'Agente is AI that speaks your language, understands your business, and never sleeps. We believe every small business deserves the same level of automation that big companies have — without the big company price tag.',
      ...
      'contact.form.success.link': 'Chat with Agente on WhatsApp',

      // Final CTA
      'cta.title': 'Stop losing sales to slow replies.',
      'cta.desc': 'Every minute a customer waits is a sale you might lose. Let Agente respond instantly, take orders automatically, and grow your revenue while you sleep.',
      'cta.button': 'Write to Agente on WhatsApp — Let\'s Go!',
      ...
      'footer.rights': '2026 Agente. All rights reserved.',
      'footer.made': 'Made with love in Latin America.',

      // WhatsApp float
      'wa.tooltip': 'Chat with Agente',
    },
    ...
    es: {
      ...
      'nav.cta': 'Habla con Agente',

      'hero.badge': 'Automatizando 1,000+ Negocios',
      'hero.title.1': 'Tu WhatsApp.',
      'hero.title.2': 'Ahora una Maquina de Ventas con IA.',
      'hero.subtitle': 'Agente transforma tu WhatsApp en un asistente de IA incansable que atiende clientes, toma pedidos, procesa pagos y gestiona todo tu negocio — las 24 horas del dia, los 7 dias de la semana.',
      ...
      'features.subtitle': 'Desde el primer mensaje del cliente hasta la entrega final — Agente lo maneja todo a traves de la app que tus clientes ya usan todos los dias.',
      ...
      'step.1.desc': 'Escanea un codigo QR desde tu dashboard y Agente se conecta a tu numero de WhatsApp Business. Eso es todo — tu IA ya esta escuchando.',
      ...
      'step.3.desc': 'Agente maneja conversaciones, crea pedidos, procesa pagos y mantiene felices a tus clientes — mientras tu monitoreas todo desde tu dashboard.',

      'test.tag': 'Testimonios',
      'test.title.1': 'Amado por duenos de negocios',
      'test.title.2': 'que nunca miran atras.',
      'test.1.text': '"Antes de Agente respondia mensajes de WhatsApp hasta las 2am. Ahora mi IA maneja todo y despierto con pedidos confirmados y pagados. Mis ventas se triplicaron el primer mes."',
      'test.2.text': '"La integracion de pagos con Yape es magia. Los clientes pagan, Agente confirma automaticamente, y el pedido empieza a prepararse. Ya ni reviso mi celular."',
      'test.3.text': '"Vendo ropa online y Agente maneja todas las preguntas de tallas, stock y creacion de pedidos. Es como tener un empleado de tiempo completo que nunca duerme y nunca se equivoca."',
      ...
      'price.starter.desc': 'Perfecto para probar Agente y ver la magia',
      ...
      'about.tag': 'Sobre Agente',
      'about.title.1': 'Hecho por emprendedores,',
      'about.title.2': 'para emprendedores.',
      'about.p1': 'Creamos Agente porque vimos a duenos de pequenos negocios en Latinoamerica ahogandose en mensajes de WhatsApp — respondiendo tarde, perdiendo pedidos y agotandose. No necesitaban otra herramienta SaaS complicada. Necesitaban algo que simplemente funcione, dentro de la app que ya usan.',
      'about.p2': 'Agente es IA que habla tu idioma, entiende tu negocio y nunca duerme. Creemos que cada pequeno negocio merece el mismo nivel de automatizacion que las grandes empresas — sin el precio de gran empresa.',
      ...
      'contact.form.success.link': 'Habla con Agente en WhatsApp',

      'cta.title': 'Deja de perder ventas por responder tarde.',
      'cta.desc': 'Cada minuto que un cliente espera es una venta que puedes perder. Deja que Agente responda al instante, tome pedidos automaticamente y haga crecer tus ingresos mientras duermes.',
      'cta.button': 'Escribele a Agente por WhatsApp — Vamos!',
      ...
      'footer.rights': '2026 Agente. Todos los derechos reservados.',
      'footer.made': 'Hecho con amor en Latinoamerica.',

      'wa.tooltip': 'Habla con Agente',
    },
    ...
    pt: {
      ...
      'nav.about': 'Sobre',
      'nav.contact': 'Contato',
      'nav.cta': 'Fale com Agente',

      'hero.badge': 'Automatizando 1.000+ Negocios',
      'hero.title.1': 'Seu WhatsApp.',
      'hero.title.2': 'Agora uma Maquina de Vendas com IA.',
      'hero.subtitle': 'Agente transforma seu WhatsApp em um assistente de IA incansavel que atende clientes, recebe pedidos, processa pagamentos e gerencia todo o seu negocio — 24 horas por dia, 7 dias por semana.',
      ...
      'features.subtitle': 'Da primeira mensagem do cliente ate a entrega final — Agente cuida de tudo pelo app que seus clientes ja usam todos os dias.',
      ...
      'step.1.desc': 'Escaneie um codigo QR no seu dashboard e Agente se conecta ao seu numero WhatsApp Business. So isso — sua IA ja esta ouvindo.',
      ...
      'step.3.desc': 'Agente cuida das conversas, cria pedidos, processa pagamentos e mantem seus clientes felizes — enquanto voce acompanha tudo pelo dashboard.',

      'test.tag': 'Depoimentos',
      'test.title.1': 'Amado por donos de negocios',
      'test.title.2': 'que nunca olham para tras.',
      'test.1.text': '"Antes do Agente eu respondia mensagens no WhatsApp ate as 2h da manha. Agora minha IA cuida de tudo e acordo com pedidos confirmados e pagos. Minhas vendas triplicaram no primeiro mes."',
      'test.2.text': '"A integracao de pagamento com Yape e magica. Clientes pagam, Agente confirma automaticamente, e o pedido comeca a ser preparado. Nem preciso mais olhar meu celular."',
      'test.3.text': '"Vendo roupas online e Agente cuida de todas as perguntas sobre tamanhos, estoque e criacao de pedidos. E como ter um funcionario em tempo integral que nunca dorme e nunca erra."',
      ...
      'price.starter': 'Inicial',
      'price.starter.desc': 'Perfeito para experimentar Agente e ver a magia',
      ...
      'about.p1': 'Criamos Agente porque vimos donos de pequenos negocios na America Latina se afogando em mensagens de WhatsApp — respondendo tarde, perdendo pedidos e se esgotando. Eles nao precisavam de outra ferramenta SaaS complicada. Precisavam de algo que simplesmente funciona, dentro do app que ja usam.',
      'about.p2': 'Agente e IA que fala seu idioma, entende seu negocio e nunca dorme. Acreditamos que todo pequeno negocio merece o mesmo nivel de automacao que as grandes empresas — sem o preco de grande empresa.',
      ...
      'contact.form.success.link': 'Fale com Agente no WhatsApp',

      'cta.title': 'Pare de perder vendas por respostas lentas.',
      'cta.desc': 'Cada minuto que um cliente espera e uma venda que voce pode perder. Deixe Agente responder instantaneamente, receber pedidos automaticamente e aumentar sua receita enquanto voce dorme.',
      'cta.button': 'Escreva para Agente no WhatsApp — Vamos!',
      ...
      'footer.rights': '2026 Agente. Todos os direitos reservados.',
      'footer.made': 'Feito com amor na America Latina.',

      'wa.tooltip': 'Fale com Agente',
    },
  };
  ...
  window.AgenteI18n = { applyLanguage, currentLang: () => currentLang, translations: T };
