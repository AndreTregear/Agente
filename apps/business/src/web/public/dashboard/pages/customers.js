// Agente Dashboard — Customers Page
...
window._viewCustomer = async (id) => {
  try {
    ...
    AgenteModal.open(esc(customer.name), `
      <div class="mb-16">
        ...
        <strong>Cliente desde:</strong> ${formatDate(customer.createdAt || customer.created_at)}
      </div>
...
function showNewCustomerModal() {
  AgenteModal.open('Nuevo Cliente', `
