...
| **yaya-billing** | Subscription & Billing Management — Manages Agente's own B2B billing via Lago: plans, upgrades, invoicing, dunning |
...
| Skill | Description |
|-------|-------------|
| **yaya-meta** | Agente Platform Sales & Self-Onboarding — The skill that sells Agente itself: demos, pricing, lead capture, trial setup |
