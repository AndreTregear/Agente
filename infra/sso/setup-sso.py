...
AUTH_FLOW = os.environ.get("AUTHENTIK_AUTH_FLOW", "")
INVALIDATION_FLOW = os.environ.get("AUTHENTIK_INVALIDATION_FLOW", "")
SIGNING_KEY = os.environ.get("AUTHENTIK_SIGNING_KEY", "")
