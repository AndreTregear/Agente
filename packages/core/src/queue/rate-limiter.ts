/**
 * Per-tenant rate limiter and AI concurrency limiter.
...
const DEFAULT_RATE_LIMIT = Number(process.env.RATE_LIMIT) || 30;
const DEFAULT_RATE_WINDOW_SEC = Number(process.env.RATE_WINDOW_SEC) || 60;
const DEFAULT_AI_CONCURRENCY = Number(process.env.AI_CONCURRENCY) || 5;
